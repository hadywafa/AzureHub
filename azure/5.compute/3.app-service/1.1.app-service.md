...
<div align="center" style="background-color: #ffffffff ;border-radius: 10px;border: 2px solid white;margin: 0 10px">
  <img src="image/1.1.app-service/1758222470174.png" alt="Without App Service" style="width: 70%; border-radius: 10px; border: 2px solid white;">
</div>
...
<div align="center">
  <img src="image/1.1.app-service/without-app-service.png" alt="Without App Service" style="width: 100%; border-radius: 10px; border: 2px solid white;margin:0 30px">
</div>

- **With App Service**: Infrastructure is fully managed, allowing developers to focus on application development and logic.

<div align="center">
  <img src="image/1.1.app-service/with-app-service.png" alt="With App Service" style="width: 100%; border-radius: 10px; border: 2px solid white;margin:0 30px">
</div>
