...
- Maximum size of a single blob in Azure Blob storage is `4.75 TB`
...
📌 **Use case**: Managing config files, templates, or datasets where rollback and auditability are critical.
