...
> 📖 _An Administrative Unit (AU) is a container of EntraID resources (users, groups, devices) that allows you to delegate administrative permissions over just those resources._
>
